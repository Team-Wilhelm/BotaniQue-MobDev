...
abstract class $ClientWantsToUpdateProfileCopyWith<$Res> {
  ...
  @useResult
  $Res call({String jwt, UpdateUserDto updateUserDto, String eventType});
...
class _$ClientWantsToUpdateProfileImpl implements _ClientWantsToUpdateProfile {
  ...
  @override
  String toString() {
    return 'ClientWantsToUpdateProfile(jwt: $jwt, updateUserDto: $updateUserDto, eventType: $eventType)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, jwt, updateUserDto, eventType);
...
abstract class _ClientWantsToUpdateProfile
  ...
  const factory _ClientWantsToUpdateProfile(
      ...
      required final String eventType}) = _$ClientWantsToUpdateProfileImpl;
